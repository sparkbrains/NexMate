...
const PricingScreen = ({ isLanding }) => {
  return (
    <div className={isLanding ? '' : 'nm-main'} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: isLanding ? '40px 20px 80px' : '60px 20px', overflowY: isLanding ? 'visible' : 'auto', position: 'relative' }}>
      <div style={{ textAlign: 'center', marginBottom: 60, marginTop: isLanding ? 24 : 0 }}>
      ...
      <div style={{ display: 'flex', gap: 24, maxWidth: 1000, width: '100%', justifyContent: 'center', flexWrap: 'wrap', alignItems: 'stretch' }}>
        ...
        <div className="nm-card" style={{ flex: '1 1 300px', maxWidth: 320, display: 'flex', flexDirection: 'column', border: '2px solid var(--teal)', boxShadow: '0 8px 30px rgba(78, 205, 196, 0.25)', position: 'relative' }}>
          <div style={{ position: 'absolute', top: -12, left: '50%', transform: 'translateX(-50%)', background: 'var(--teal)', color: 'var(--surface)', padding: '4px 12px', borderRadius: 12, fontSize: 12, fontWeight: 600, letterSpacing: '0.05em', whiteSpace: 'nowrap' }}>MOST POPULAR</div>
          <Crown color="#C0C0C0" />
        ...
        {/* Gold Plan */}
        <div className="nm-card" style={{ flex: '1 1 300px', maxWidth: 320, display: 'flex', flexDirection: 'column', border: '2px solid #b8860b', boxShadow: '0 8px 30px rgba(184, 134, 11, 0.25)' }}>
          <Crown color="#FFD700" />
          <div className="nm-h2" style={{ marginBottom: 8, color: '#b8860b', textAlign: 'center' }}>Gold</div>
          ...
          <button className="nm-btn accent" style={{ width: '100%', marginBottom: 32, background: 'var(--land-gold)', color: '#2b2013', boxShadow: '0 4px 12px rgba(184, 134, 11, 0.4)' }}>Upgrade to Gold</button>
