      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {quoted && (
          ...
          >
            <div
              className="nm-meta"
              style={{ marginBottom: 4, color: "var(--accent-2)" }}
            >
              — {quoted.date}
            </div>
            <div
        ...
        {meta && (
          <div className="nm-meta" style={{ marginTop: 6 }}>
            {meta}
          </div>
        )}
      </div>
...
export const ChatScreen = ({
  ...
  const { messages, streaming, status, error, send, loadHistory } =
    useChatSocket(threadId, { onDone: onMessageDone });
  ...
  useEffect(() => {
    ...
    getThreadMessages(threadId)
      .then((data) => {
        if (!off) loadHistory(data.messages);
      })
      .catch(() => {});
    return () => {
      off = true;
    ...
    <div className="nm-main">
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0 }}>
        ...
        >
          ...
          >
            <button className="nm-btn speak-btn" style={{ padding: 8 }}>
            ...
            <textarea
              ...
              placeholder={
                threadId
                  ? "Stay with the thought, or send a new one…"
        ...
        >
            ...
            <div className="nm-card" style={{ padding: 12, marginBottom: 16 }}>
              ...
              >
                ...
                <div style={{ minWidth: 0, flex: 1 }}>
                  ...
                  >
                    active · {topLoop.strength.toFixed(2)} ·{" "}
                    {topLoop.occurrences}×
                  </div>
                </div>
              </div>
              {activeLoops.length > 1 && (
                <div
                  className="nm-meta"
                  style={{ fontSize: 9.5, marginTop: 8 }}
                >
          ...
          <div
            className="nm-meta"
            style={{ lineHeight: 1.5, color: "var(--ink-4)" }}
          >
            Nextmate doesn't provide clinical advice. Safety screens run on
            every message.
          </div>
        </aside>
      </div>
